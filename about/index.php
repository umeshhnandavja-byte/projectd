...
<div id='aboutus'>
   <div class="hero-section">
    ...
    <section>
        <h2>Our Story</h2>
        <p>Founded in 2026, ProjectD started with a simple observation: many people want to help, but they don't always know where their money goes. We built this platform to provide a direct, verifiable connection between organizations in need and the community.</p>
    </section>
