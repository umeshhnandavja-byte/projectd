<html>
    ...
    <section>
        ...
        <p>By accessing and using this fundraising platform ("ProjectD"), you agree to be bound by these Terms and Conditions. If you do not agree, please discontinue use immediately.</p>
    </section>

    <section>
        <h2>2. Donation Policy</h2>
        <p>All donations made through ProjectD are voluntary and <strong>non-refundable</strong>. Once a transaction is completed and updated in your profile, the funds are allocated to the respective organization.</p>
    </section>

    <section>
        <h2>3. Use of Funds</h2>
        <p>While we strive to host legitimate organizations, ProjectD acts as a facilitator. Donors are encouraged to perform their own due diligence before contributing. ProjectD is not responsible for the ultimate usage of funds by the organization once transferred.</p>
    </section>
    ...
    <section>
        ...
        <p>ProjectD shall not be liable for any direct, indirect, or incidental damages resulting from the use or inability to use the platform, including but not limited to failed transactions or data loss.</p>
    </section>

</div>

    <div id='footer'>
        <a>About</a> <a>Terms&Conditions</a> <a>PrivacyPolicy </a><br><br><label>&copy2026@Projectd</label>
    </div>
</body>
</html>
